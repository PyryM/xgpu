...
} WGPUNativeSType WGPU_ENUM_ATTRIBUTE;
...
} WGPUNativeFeature WGPU_ENUM_ATTRIBUTE;
...
} WGPUInstanceBackend WGPU_ENUM_ATTRIBUTE;
typedef WGPUFlags WGPUInstanceBackendFlags WGPU_ENUM_ATTRIBUTE;
...
} WGPUInstanceFlag WGPU_ENUM_ATTRIBUTE;
typedef WGPUFlags WGPUInstanceFlags WGPU_ENUM_ATTRIBUTE;
...
} WGPURequiredLimitsExtras WGPU_STRUCTURE_ATTRIBUTE;

typedef struct WGPUSupportedLimitsExtras {
    WGPUChainedStructOut chain;
    WGPUNativeLimits limits;
} WGPUSupportedLimitsExtras WGPU_STRUCTURE_ATTRIBUTE;

typedef struct WGPUPushConstantRange {
    WGPUShaderStageFlags stages;
    uint32_t start;
    uint32_t end;
} WGPUPushConstantRange WGPU_STRUCTURE_ATTRIBUTE;
...
} WGPUWrappedSubmissionIndex WGPU_STRUCTURE_ATTRIBUTE;
...
typedef struct WGPUStorageReport {
    ...
    size_t numError;
    size_t elementSize;
} WGPUStorageReport WGPU_STRUCTURE_ATTRIBUTE;
...
typedef void (*WGPULogCallback)(WGPULogLevel level, char const * message, void * userdata) WGPU_FUNCTION_ATTRIBUTE;

WGPU_EXPORT void wgpuGenerateReport(WGPUInstance instance, WGPUGlobalReport * report) WGPU_FUNCTION_ATTRIBUTE;
WGPU_EXPORT size_t wgpuInstanceEnumerateAdapters(WGPUInstance instance, WGPUInstanceEnumerateAdapterOptions const * options, WGPUAdapter * adapters) WGPU_FUNCTION_ATTRIBUTE;
...
WGPU_EXPORT void wgpuRenderPassEncoderMultiDrawIndirectCount(WGPURenderPassEncoder encoder, WGPUBuffer buffer, uint64_t offset, WGPUBuffer count_buffer, uint64_t count_buffer_offset, uint32_t max_count) WGPU_FUNCTION_ATTRIBUTE;
WGPU_EXPORT void wgpuRenderPassEncoderMultiDrawIndexedIndirectCount(WGPURenderPassEncoder encoder, WGPUBuffer buffer, uint64_t offset, WGPUBuffer count_buffer, uint64_t count_buffer_offset, uint32_t max_count) WGPU_FUNCTION_ATTRIBUTE;
