...
class BufferUsageFlags:
    def __init__(self, flags: Union[list["BufferUsage"], int]):
    ...
    @property
    def MapRead(self) -> bool:
        return (self.value & 0x00000001) > 0

    @MapRead.setter
    def MapRead(self, enabled: bool):
        if enabled:
            self.value |= 0x00000001
        else:
            self.value &= ~(0x00000001)

    @property
    def MapWrite(self) -> bool:
        return (self.value & 0x00000002) > 0

    @MapWrite.setter
    def MapWrite(self, enabled: bool):
        if enabled:
            self.value |= 0x00000002
        else:
            self.value &= ~(0x00000002)

    @property
    def CopySrc(self) -> bool:
        return (self.value & 0x00000004) > 0

    @CopySrc.setter
    def CopySrc(self, enabled: bool):
        if enabled:
            self.value |= 0x00000004
        else:
            self.value &= ~(0x00000004)

    @property
    def CopyDst(self) -> bool:
        return (self.value & 0x00000008) > 0

    @CopyDst.setter
    def CopyDst(self, enabled: bool):
        if enabled:
            self.value |= 0x00000008
        else:
            self.value &= ~(0x00000008)

    @property
    def Index(self) -> bool:
        return (self.value & 0x00000010) > 0

    @Index.setter
    def Index(self, enabled: bool):
        if enabled:
            self.value |= 0x00000010
        else:
            self.value &= ~(0x00000010)

    @property
    def Vertex(self) -> bool:
        return (self.value & 0x00000020) > 0

    @Vertex.setter
    def Vertex(self, enabled: bool):
        if enabled:
            self.value |= 0x00000020
        else:
            self.value &= ~(0x00000020)

    @property
    def Uniform(self) -> bool:
        return (self.value & 0x00000040) > 0

    @Uniform.setter
    def Uniform(self, enabled: bool):
        if enabled:
            self.value |= 0x00000040
        else:
            self.value &= ~(0x00000040)

    @property
    def Storage(self) -> bool:
        return (self.value & 0x00000080) > 0

    @Storage.setter
    def Storage(self, enabled: bool):
        if enabled:
            self.value |= 0x00000080
        else:
            self.value &= ~(0x00000080)

    @property
    def Indirect(self) -> bool:
        return (self.value & 0x00000100) > 0

    @Indirect.setter
    def Indirect(self, enabled: bool):
        if enabled:
            self.value |= 0x00000100
        else:
            self.value &= ~(0x00000100)

    @property
    def QueryResolve(self) -> bool:
        return (self.value & 0x00000200) > 0

    @QueryResolve.setter
    def QueryResolve(self, enabled: bool):
        if enabled:
            self.value |= 0x00000200
        else:
            self.value &= ~(0x00000200)


class ColorWriteMaskFlags:
    def __init__(self, flags: Union[list["ColorWriteMask"], int]):
        if isinstance(flags, int):
            self.value = flags
        else:
            self.value = sum(set(flags))
    ...
    @property
    def All(self) -> bool:
        return (self.value & 0x0000000F) > 0

    @All.setter
    def All(self, enabled: bool):
        if enabled:
            self.value |= 0x0000000F
        else:
            self.value &= ~(0x0000000F)


class MapModeFlags:
    def __init__(self, flags: Union[list["MapMode"], int]):
        if isinstance(flags, int):
            self.value = flags
        else:
            self.value = sum(set(flags))
...
class ShaderStageFlags:
    def __init__(self, flags: Union[list["ShaderStage"], int]):
        if isinstance(flags, int):
            self.value = flags
        else:
            self.value = sum(set(flags))
    ...
    @Fragment.setter
    def Fragment(self, enabled: bool):
        if enabled:
            self.value |= 0x00000002
        else:
            self.value &= ~(0x00000002)
...
class TextureUsageFlags:
    def __init__(self, flags: Union[list["TextureUsage"], int]):
        if isinstance(flags, int):
            self.value = flags
        else:
            self.value = sum(set(flags))
    ...
    @property
    def TextureBinding(self) -> bool:
        return (self.value & 0x00000004) > 0

    @TextureBinding.setter
    def TextureBinding(self, enabled: bool):
        if enabled:
            self.value |= 0x00000004
        else:
            self.value &= ~(0x00000004)
    ...
    @property
    def StorageBinding(self) -> bool:
        return (self.value & 0x00000008) > 0

    @StorageBinding.setter
    def StorageBinding(self, enabled: bool):
        if enabled:
            self.value |= 0x00000008
        else:
            self.value &= ~(0x00000008)
    ...
    @property
    def RenderAttachment(self) -> bool:
        return (self.value & 0x00000010) > 0

    @RenderAttachment.setter
    def RenderAttachment(self, enabled: bool):
        if enabled:
            self.value |= 0x00000010
        else:
            self.value &= ~(0x00000010)
...
class InstanceBackendFlags:
    def __init__(self, flags: Union[list["InstanceBackend"], int]):
        if isinstance(flags, int):
            self.value = flags
        else:
            self.value = sum(set(flags))
    ...
    @property
    def BrowserWebGPU(self) -> bool:
        return (self.value & 1 << 5) > 0

    @BrowserWebGPU.setter
    def BrowserWebGPU(self, enabled: bool):
        if enabled:
            self.value |= 1 << 5
        else:
            self.value &= ~(1 << 5)
...
class InstanceFlags:
    def __init__(self, flags: Union[list["InstanceFlag"], int]):
        if isinstance(flags, int):
            self.value = flags
        else:
            self.value = sum(set(flags))
    ...
    @Validation.setter
    def Validation(self, enabled: bool):
        if enabled:
            self.value |= 1 << 1
        else:
            self.value &= ~(1 << 1)
    ...
    @property
    def DiscardHalLabels(self) -> bool:
        return (self.value & 1 << 2) > 0

    @DiscardHalLabels.setter
    def DiscardHalLabels(self, enabled: bool):
        if enabled:
            self.value |= 1 << 2
        else:
            self.value &= ~(1 << 2)
